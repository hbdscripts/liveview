...
(function () {
  ...
  function apiGetJson(url) {
    return fetchWithTimeout(url, { credentials: 'same-origin', cache: 'no-store' }, 25000)
      ...
      .catch(function (err) {
        try { console.warn('[attribution-tree] apiGetJson failed', url, err); } catch (_) {}
        try {
          if (window.kexoSentry && typeof window.kexoSentry.captureException === 'function') {
            window.kexoSentry.captureException(err, { context: 'attributionTree.apiGetJson', url: String(url || '') }, 'warning');
          }
        } catch (_) {}
        return null;
      });
    ...
    return fetchWithTimeout(url, {
      ...
      .then(function (r) {
        return r.json().catch(function (err) {
          try { console.warn('[attribution-tree] apiPostJson invalid json', url, r && r.status, err); } catch (_) {}
          try {
            if (window.kexoSentry && typeof window.kexoSentry.captureException === 'function') {
              window.kexoSentry.captureException(err, { context: 'attributionTree.apiPostJson.invalidJson', url: String(url || ''), status: r && r.status }, 'warning');
            }
          } catch (_) {}
          return null;
        }).then(function (body) {
      ...
      .catch(function (err) {
        try { console.warn('[attribution-tree] apiPostJson failed', url, err); } catch (_) {}
        try {
          if (window.kexoSentry && typeof window.kexoSentry.captureException === 'function') {
            window.kexoSentry.captureException(err, { context: 'attributionTree.apiPostJson', url: String(url || '') }, 'warning');
          }
        } catch (_) {}
  ...
  function apiPatchJson(url, payload) {
    return fetchWithTimeout(url, {
      ...
      .then(function (r) {
        return r.json().catch(function (err) {
          try { console.warn('[attribution-tree] apiPatchJson invalid json', url, r && r.status, err); } catch (_) {}
          try {
            if (window.kexoSentry && typeof window.kexoSentry.captureException === 'function') {
              window.kexoSentry.captureException(err, { context: 'attributionTree.apiPatchJson.invalidJson', url: String(url || ''), status: r && r.status }, 'warning');
            }
          } catch (_) {}
          return null;
        }).then(function (body) {
      ...
      .catch(function (err) {
        try { console.warn('[attribution-tree] apiPatchJson failed', url, err); } catch (_) {}
        try {
          if (window.kexoSentry && typeof window.kexoSentry.captureException === 'function') {
            window.kexoSentry.captureException(err, { context: 'attributionTree.apiPatchJson', url: String(url || '') }, 'warning');
          }
        } catch (_) {}
        return { ok: false, status: 0, error: 'Request failed' };
      });
  ...
  function apiDeleteJson(url) {
    return fetchWithTimeout(url, {
      ...
      .then(function (r) {
        return r.json().catch(function (err) {
          try { console.warn('[attribution-tree] apiDeleteJson invalid json', url, r && r.status, err); } catch (_) {}
          try {
            if (window.kexoSentry && typeof window.kexoSentry.captureException === 'function') {
              window.kexoSentry.captureException(err, { context: 'attributionTree.apiDeleteJson.invalidJson', url: String(url || ''), status: r && r.status }, 'warning');
            }
          } catch (_) {}
          return null;
        }).then(function (body) {
      ...
      .catch(function (err) {
        try { console.warn('[attribution-tree] apiDeleteJson failed', url, err); } catch (_) {}
        try {
          if (window.kexoSentry && typeof window.kexoSentry.captureException === 'function') {
            window.kexoSentry.captureException(err, { context: 'attributionTree.apiDeleteJson', url: String(url || '') }, 'warning');
          }
        } catch (_) {}
        return { ok: false, status: 0, error: 'Request failed' };
      });
