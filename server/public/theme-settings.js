(function () {
  ...
  var ICON_GLYPH_META = {
    ...
    'admin-tab-table-row-merge': { title: 'Admin - Table row merge', help: 'Merge icon used for row actions in Settings/Admin tables (e.g. Insights Variants rule merge).' },
  ...
  function iconGroupIdForName(name) {
    ...
    if (key.indexOf('dashboard-kpi-') === 0) return 'dashboard';
  ...
  function buildGlyphAccordionHtml() {
    ...
    var order = ['header-nav', 'footer', 'mobile-icons', 'tables', 'cards', 'dashboard', 'runtime', 'admin', 'misc'];
