...
(function () {
  ...
  window.KEXO_CHART_DEFS = {
    ...
    'dash-chart-finishes-30d': { modes: ['radialbar', 'bar-horizontal', 'bar', 'bar-distributed', 'line', 'area', 'multi-line-labels', 'pie', 'donut'], series: ['Revenue by finish'], defaultMode: 'radialbar', height: 240, colorSlots: 5 },
    ...
    'dash-chart-devices-30d': { modes: ['bar-horizontal', 'bar', 'bar-distributed', 'line', 'area', 'multi-line-labels'], series: ['Sessions by platform'], defaultMode: 'bar-horizontal', height: 240, colorSlots: 5 },
    'dash-chart-attribution-30d': { modes: ['donut', 'pie', 'bar-horizontal', 'bar', 'bar-distributed', 'line', 'area', 'multi-line-labels', 'radialbar'], series: ['Revenue by source'], defaultMode: 'donut', height: 240, colorSlots: 5, capabilities: { icons: true } },
