...
(function () {
  ...
  function defaultChartsUiConfigV1() {
    var baseCharts = [
      ...
      { key: 'countries-map-chart', label: 'Insights · Countries Map', enabled: true, mode: 'map-animated', colors: ['#3eb3ab'], advancedApexOverride: {} },
    ].map(function (it) {
  ...
  function normalizeChartStyleDraft(raw, fallback) {
    ...
    return {
      ...
      mapFit: mapFit,
      mapInactiveOpacity: safeNumber(src.mapInactiveOpacity, def.mapInactiveOpacity, 0, 1),
