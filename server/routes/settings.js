...
const CHART_ALLOWED_MODES = Object.freeze({
  ...
  'overview-live-online-chart': ['map-animated'],
        ...
        tables: [
          {
            ...
            order: 1,
            inGrid: true,
            rows: { default: 5, options: [5, 10, 15, 20] },
            sticky: { minWidth: null, maxWidth: null },
          },
          {
          ...
          {
            id: 'products-gross-profit-high-table',
            name: 'Gross profit (High)',
            tableClass: 'product',
            zone: '',
            order: 1,
            inGrid: true,
          ...
          {
            id: 'products-gross-profit-low-table',
            name: 'Gross profit (Low)',
            tableClass: 'product',
            zone: '',
            order: 2,
            inGrid: true,
...
function normalizeChartStyle(raw, fallback) {
  ...
  return {
    ...
    lineOpacity: parseBoundedNumber(src.lineOpacity, def.lineOpacity != null ? def.lineOpacity : 1, 0, 1),
...
async function getChartSettings(req, res) {
  try {
    ...
    const settings = entry || defaultEntry;
