...
const ICON_GLYPH_DEFAULTS = Object.freeze({
  ...
  'nav-item-settings-menu-view-all': 'fa-gear',
  'nav-item-settings-menu-attribution-map': 'fa-map-location-dot',
  'nav-item-settings-menu-costs-expenses': 'fa-receipt',
  'nav-item-settings-menu-variant-management': 'fa-bezier-curve',
  ...
  'notifications-type-sentry': 'fa-solid fa-bug',
  'notifications-type-pending-signup': 'fa-solid fa-user-clock',
  'notifications-type-diagnostics-unresolved': 'fa-solid fa-wrench',
  'notifications-type-default': 'fa-solid fa-bell',
  'notifications-action-archive': 'fa-solid fa-archive',
  'notifications-action-delete': 'fa-solid fa-trash',
  'notifications-back': 'fa-jelly fa-arrow-left',
  ...
  'dashboard-kpi-revenue': 'fa-light fa-sterling-sign',
  'dashboard-kpi-profit': 'fa-light fa-chart-line',
  'dashboard-kpi-conversion-rate': 'fa-light fa-percent',
  'dashboard-kpi-value-per-visit': 'fa-light fa-sack-dollar',
  'dashboard-kpi-returning-customers': 'fa-light fa-user-check',
  'dashboard-kpi-sessions': 'fa-light fa-users',
  'dashboard-kpi-orders': 'fa-light fa-cart-shopping',
  'dashboard-kpi-aov': 'fa-light fa-basket-shopping',
  'dashboard-kpi-bounce-rate': 'fa-light fa-person-walking-arrow-right',
  'dashboard-kpi-returns': 'fa-light fa-rotate-left',
  ...
  'admin-tab-table-row-edit': 'fa-light fa-pencil',
  'admin-tab-table-row-delete': 'fa-light fa-trash-xmark',
  'admin-tab-table-row-merge': 'fa-light fa-code-merge',
  'admin-tab-cost-breakdown-total-active': 'fa-light fa-circle-check',
  'admin-tab-cost-breakdown-total-inactive': 'fa-light fa-circle-minus',
});
