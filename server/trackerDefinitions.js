...
const TRACKER_TABLE_DEFINITIONS = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'Integrations', value: 'Profit Rules → Integrations tab: toggles for Google Ads spend, Shopify app bills, Transaction Fees, and Shopify Fees' },
    ...
    math: [
      ...
      { name: 'Cost (chart line)', value: 'COGS + enabled Profit Rule deductions + optional integration costs (Google Ads, app bills, Transaction Fees, Shopify Fees)' },
