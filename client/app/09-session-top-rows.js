    ...
    function refreshConfigStatus(options = {}) {
      ...
      const p = (!!options.force
        ...
        .then(c => {
          ...
          function accordionItem(key, title, bodyHtml) {
            ...
            return (
              '<div class="accordion-item">' +
                '<h4 class="accordion-header settings-panel-heading" data-settings-ui-heading="1" id="' + escapeHtml(headingId) + '">' +
          ...
          try {
            ...
            googleAdsBody +=   '<div class="col-12 col-xl-6">' + cardSm('Actions', (
              '<div class="d-flex align-items-center gap-2 flex-wrap">' +
                ...
                '<button type="button" id="ga-status-btn" class="btn btn-md btn-sm">' + copyIcon + ' Status</button>' +
                '<button type="button" id="ga-summary-btn" class="btn btn-md btn-sm">' + copyIcon + ' Summary</button>' +
                '<button type="button" id="ga-refresh-7d-btn" class="btn btn-md btn-sm">' + copyIcon + ' Refresh 7d</button>' +
                '<button type="button" id="ga-refresh-month-btn" class="btn btn-md btn-sm">' + copyIcon + ' Refresh month</button>' +
          ...
          advancedBody +=   '<button type="button" id="be-copy-ai-btn" class="btn btn-md btn-sm" title="Copy a detailed diagnostics payload for AI">' + copyIcon + ' Copy AI debug</button>';
          advancedBody +=   '<button type="button" id="be-download-ai-json-btn" class="btn btn-md btn-sm" title="Download diagnostics JSON for AI"><i class="fa-light fa-download" aria-hidden="true"></i> Download JSON</button>';
